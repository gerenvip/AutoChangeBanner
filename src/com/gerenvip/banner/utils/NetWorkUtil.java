...
public class NetWorkUtil {
    ...
    /** Same to {@link android.net.ConnectivityManager#TYPE_WIMAX} (API 8) */
    private static final int CM_TYPE_WIMAX = 6;
    /** Same to {@link android.net.ConnectivityManager#TYPE_ETHERNET} (API 13) */
    private static final int CM_TYPE_ETHERNET = 9;
    /** Same to {@link android.net.ConnectivityManager#TYPE_MOBILE_MMS} (API 8) */
    private static final int CM_TYPE_MOBILE_MMS = 2;
    /** Same to {@link android.net.ConnectivityManager#TYPE_BLUETOOTH} (API 8) */
    private static final int CM_TYPE_BLUETOOTH = 7;

    /** Same to {@link android.telephony.TelephonyManager#NETWORK_TYPE_EVDO_B} (API 9) 5 Mbps */
    private static final int TM_NETWORK_TYPE_EVDO_B = 12;
    /** Same to {@link android.telephony.TelephonyManager#NETWORK_TYPE_LTE} (API 11) 10+ Mbps */
    private static final int TM_NETWORK_TYPE_LTE = 13;
    /** Same to {@link android.telephony.TelephonyManager#NETWORK_TYPE_EHRPD} (API 11) 1~2 Mbps */
    private static final int TM_NETWORK_TYPE_EHRPD = 14;
    /** Same to {@link android.telephony.TelephonyManager#NETWORK_TYPE_HSPAP} (API 13) 10~20 Mbps */
    ...
    public static int getNetworkType(Context context) {
        ...
        if (netInfo != null) {
            ...
            LogHelper.d(TAG, "network type = " + type + " : " + subType);
